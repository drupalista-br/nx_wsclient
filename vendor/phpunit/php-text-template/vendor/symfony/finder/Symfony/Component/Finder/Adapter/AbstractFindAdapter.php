...
abstract class AbstractFindAdapter extends AbstractAdapter
{
    ...
    { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($command, $names, $not), false)) !== __AM_CONTINUE__) return $__am_res; 
        if (0 === count($names)) {
            return;
        }
    ...
    { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($command, $dir, $paths, $not), false)) !== __AM_CONTINUE__) return $__am_res; 
        if (0 === count($paths)) {
            return;
        }
    ...
    { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($command, $sizes), false)) !== __AM_CONTINUE__) return $__am_res; 
    ...
    { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($command, $dates), false)) !== __AM_CONTINUE__) return $__am_res; 
