...
<div class="ready-accordion">
  ...
  Os custos e despesas do Lojista serão os seguintes:
	<ul>
      ...
      <br />
	  <li>Um <a href="https://pt.wikipedia.org/wiki/Cons%C3%B3rcio_de_empresas#Brasil">consórcio</a> será criado e
        este será credenciado junto a Cielo ( Operadora de Cartões ). Serão membros consorciados a NortaoX.com e
        todos os Lojistas que firmarem acordos com a NortaoX.com. Será ratiado entre os Lojistas, na proporção de
        suas vendas:
        <br />
        <ul>
            <li>As taxas e comissões cobradas pela Cielo para o processamento de cartões;</li>
        </ul>
