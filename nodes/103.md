  ...
  <span class="ready-accordion-header"><h3><a name='integracao'></a><u>Integração com o Software de Gestão do Lojista</u></h3></span>
	...
	os seguintes programas:<br /><br />
		<ul>
			...
			no Banco de Dados do Software de Gestão do Lojista e sincronizar com o sistema e-Commerce remoto do
			NortaoX.com.</li>
			<br />
		</ul>
	...
	que conterá os dados dos produtos do Lojista. O NortaoX.com não será capaz de acessar outros dados, como informações
	financeiras por exemplo, que não sejam exclusicamente os dados dos produtos.<br /><br />
