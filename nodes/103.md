  ...
  <span class="ready-accordion-header"><h3><a name='caracteristicas_website'></a><u>Características do Website</u></h3></span>
	<ul>
	  ...
	  <li><h4><strong>Lojista</strong></h4>
		Os Lojistas terão acesso a uma interface própria para, entre outras coisas:
		<ul>
		  <li>Cadastrar produtos e atualizar informações dos produtos, tais como preço e quantidade em estoque;</li>
		  <li>Visualizar as informações dos pedidos que contenham seus produtos. Caso, num mesmo pedido, o comprador
			  tenha comprado produtos de mais de um Lojista, cada Lojista irá visualizar a lista de itens do pedido
			  contendo apenas seus produtos;</li>
		  <li>Acompanhar o saldo a receber, as transferências de valores efetuadas e os respectivos descontos aplicados;</li>
		</ul>
		As atividades listadas acima poderão também ser executadas diretamente no Software de Gestão que o Lojista
		já usa. No entanto, faz-se necessário que o desenvolvedor do Software de Gestão providencie a integração
		entre os dois sistemas. Mais detalhes em <a href='#integracao'>Integração com o Software de Gestão do
		Lojista</a>
	  </li>
	  <br />
...
<div class="ready-accordion">
  ...
  <ul>
	...
	<li>Fazer campanhas publicitárias.</li>
  </ul>
</div>
...
<div class="ready-accordion">
  ...
  O preço dos serviços prestados pela NortaoX.com bem como os custos financeiros irão flutuar de acordo com o volume
  de vendas do website como um todo, tendendo a reduzir a medida que o volume de vendas for aumentando.
  <br /><br />
  A nossa estimativa é que inicialmente o custo do Lojista, calculado sobre o valor total das vendas, será o seguinte:
  <br /><br />
	<ul>
	  <?php
	  $costs_nx = 7.2;
	  ...
	  ?>
	  <li><?php print $costs_nx ?>% para a NortaoX.com;</li>
	  <li>Cielo:
		<ul>
	  ...
	  <li><?php print $costs_discount_default ?>% de desconto quando o comprador escolher pagar à vista por um meio que não seja Cartão de
		  débito ou crédito.</li>
	</ul>
